import svgPaths from "./svg-gh44ewwal8";
import imgMobileHeroBanner1 from "figma:asset/06d67b0cc334919613e5f14478f394ea4e647478.png";

function Group8() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 text-black text-center">
...
function Group146() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] bg-[#8e9c78] h-[237px] ml-0 mt-[121px] rounded-[30px] w-[343px]" />
      <div className="[grid-area:1_/_1] h-[358px] ml-[18px] mt-0 relative w-[296px]" data-name="Mobile hero banner 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[108.43%] left-0 max-w-none top-[-0.03%] w-full" src={imgMobileHeroBanner1} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <header className="max-w-[1600px] relative shrink-0 w-full" data-name="Header">
      <div className="flex flex-col items-center max-w-inherit overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[56px] items-center leading-[0] max-w-inherit pb-0 pt-[120px] px-[16px] relative w-full">
          <Group8 />
          <Group146 />
        </div>
      </div>
...
function ListItem1() {
  return (
    <section aria-label="Area value prop 1 of 4" className="box-border content-stretch flex gap-[30px] items-start justify-center overflow-visible px-0 py-[20px] relative shrink-0 w-full" data-name="List Item 1">
      ...
      <p className="font-['DM_Sans:Bold',_sans-serif] font-bold leading-[1.4] relative shrink-0 text-[#485c11] text-[15px] text-nowrap tracking-[-0.075px] whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        01
      </p>
