import svgPaths from "./svg-yue72bpp2f";
...
import { imgGroup, imgGroup1, imgGroup2 } from "./svg-9rj1o";

function Group() {
  return (
    <div className="[grid-area:1_/_1] h-[22.432px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.945px_-8.561px] mask-size-[90px_38.624px] ml-[-0.003%] mt-0 relative w-[18.304px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 23">
        <g id="Group">
          <path d={svgPaths.p304f7f00} fill="var(--fill-0, #485C11)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group1() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.003%] mt-0 place-items-start relative" data-name="Group">
      <Group />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[-0.001%] mt-[22.388%] place-items-start relative" data-name="Group">
      <Group1 />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="[grid-area:1_/_1] h-[18.099px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-18.031px_-12.94px] mask-size-[90px_38.624px] ml-[-0.002%] mt-0 relative w-[21.031px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 19">
        <g id="Group">
          <path d={svgPaths.p2f7e400} fill="var(--fill-0, #485C11)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group4() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.002%] mt-0 place-items-start relative" data-name="Group">
      <Group3 />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[19.257%] mt-[34.016%] place-items-start relative" data-name="Group">
      <Group4 />
    </div>
  );
}
...
function Group6() {
  return (
    <div className="[grid-area:1_/_1] h-[22.432px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-38.145px_-8.561px] mask-size-[90px_38.624px] ml-0 mt-0 relative w-[10.777px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 23">
        <g id="Group">
          <path d={svgPaths.p3422580} fill="var(--fill-0, #485C11)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group8() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[41.927%] mt-[22.388%] place-items-start relative" data-name="Group">
      <Group7 />
    </div>
  );
}
...
function Group9() {
  return (
    <div className="[grid-area:1_/_1] h-[18.053px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-48.223px_-12.94px] mask-size-[90px_38.624px] ml-[-0.009%] mt-0 relative w-[16.693px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <div className="absolute bottom-0 left-[-0.01%] right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 19">
          <g id="Group">
            <path d={svgPaths.pfb1bf00} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group10() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.009%] mt-0 place-items-start relative" data-name="Group">
      <Group9 />
    </div>
  );
}
...
function Group11() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[53.285%] mt-[34.016%] place-items-start relative" data-name="Group">
      <Group10 />
    </div>
  );
}
...
function Group12() {
  return (
    <div className="[grid-area:1_/_1] h-[24.846px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-63.992px_-12.94px] mask-size-[90px_38.624px] ml-[0.005%] mt-0 relative w-[20.855px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 25">
        <g id="Group">
          <path d={svgPaths.p1e38ff0} fill="var(--fill-0, #485C11)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group13() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[0.005%] mt-0 place-items-start relative" data-name="Group">
      <Group12 />
    </div>
  );
}
...
function Group14() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[71.062%] mt-[34.016%] place-items-start relative" data-name="Group">
      <Group13 />
    </div>
  );
}
...
function Group15() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[3.801px] mask-position-[-60.285px,_-1.617px,_-1.617px_-5.535px,_-5.403px,_-5.535px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-[-0.027%] mt-[-0.001%] relative w-[3.591px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <div className="absolute bottom-0 left-[-0.03%] right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <g id="Group">
            <path d={svgPaths.p1edbb580} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group16() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.027%] mt-[-0.001%] place-items-start relative" data-name="Group">
      <Group15 />
    </div>
  );
}
...
function Group17() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[-0.004%] mt-[50.974%] place-items-start relative" data-name="Group">
      <Group16 />
    </div>
  );
}
...
function Group18() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[4.202px] mask-position-[-64.48px,_-5.813px,_-5.813px_-2.666px,_-2.535px,_-2.666px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-[0.016%] mt-[0.002%] relative w-[3.074px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <div className="absolute bottom-0 left-0 right-[-0.02%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 5">
          <g id="Group">
            <path d={svgPaths.p141b1300} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group19() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[0.016%] mt-[0.002%] place-items-start relative" data-name="Group">
      <Group18 />
    </div>
  );
}
...
function Group20() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[15.177%] mt-[13.978%] place-items-start relative" data-name="Group">
      <Group19 />
    </div>
  );
}
...
function Group21() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[4.034px] mask-position-[-70.004px,_-11.336px,_-11.336px_-1.582px,_-1.451px,_-1.582px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-[0.034%] mt-[-0.001%] relative w-[3.285px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <div className="absolute bottom-0 left-0 right-[-0.03%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 5">
          <g id="Group">
            <path d={svgPaths.p3eb05100} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group22() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[0.034%] mt-[-0.001%] place-items-start relative" data-name="Group">
      <Group21 />
    </div>
  );
}
...
function Group23() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[35.157%] mt-0 place-items-start relative" data-name="Group">
      <Group22 />
    </div>
  );
}
...
function Group24() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[3.99px] mask-position-[-75.563px,_-16.895px,_-16.895px_-1.626px,_-1.495px,_-1.626px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-[0.041%] mt-0 relative w-[3.533px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <div className="absolute bottom-0 left-0 right-[-0.04%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <g id="Group">
            <path d={svgPaths.p19211680} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group25() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[0.041%] mt-0 place-items-start relative" data-name="Group">
      <Group24 />
    </div>
  );
}
...
function Group26() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[55.265%] mt-[0.564%] place-items-start relative" data-name="Group">
      <Group25 />
    </div>
  );
}
...
function Group27() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[3.803px] mask-position-[-80.754px,_-22.086px,_-22.086px_-3.005px,_-2.874px,_-3.005px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-0 mt-[-0.002%] relative w-[2.015px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 4">
        <g id="Group">
          <path d={svgPaths.p3f6a9c80} fill="var(--fill-0, #485C11)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group28() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-0 mt-[-0.002%] place-items-start relative" data-name="Group">
      <Group27 />
    </div>
  );
}
...
function Group29() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[74.038%] mt-[18.353%] place-items-start relative" data-name="Group">
      <Group28 />
    </div>
  );
}
...
function Group30() {
  return (
    <div className="[grid-area:1_/_1] [mask-clip:no-clip,_no-clip,_no-clip] [mask-composite:intersect,_intersect,_intersect] [mask-mode:alpha,_alpha,_alpha] [mask-repeat:no-repeat,_no-repeat,_no-repeat] h-[3.961px] mask-position-[-84.012px,_-25.344px,_-25.344px_-5.133px,_-5.002px,_-5.133px] mask-size-[90px_38.624px,_31px_11.529px,_31.336px_11.66px] ml-[-0.037%] mt-[0.001%] relative w-[3.92px]" data-name="Group" style={{ maskImage: `url('${imgGroup}'), url('${imgGroup1}'), url('${imgGroup2}')` }}>
      <div className="absolute bottom-0 left-[-0.04%] right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <g id="Group">
            <path d={svgPaths.p20603480} fill="var(--fill-0, #485C11)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function Group31() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.037%] mt-[0.001%] place-items-start relative" data-name="Group">
      <Group30 />
    </div>
  );
}
...
function Group32() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[85.816%] mt-[45.795%] place-items-start relative" data-name="Group">
      <Group31 />
    </div>
  );
}
...
function Group33() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[5.158%] mt-[13.57%] place-items-start relative" data-name="Group">
      <Group17 />
      <Group20 />
      <Group23 />
      <Group26 />
...
function ClipPathGroup() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[-0.003%] mt-0 place-items-start relative" data-name="Clip path group">
      <Group33 />
    </div>
  );
}
...
function Group34() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[-0.003%] mt-0 place-items-start relative" data-name="Group">
      <ClipPathGroup />
    </div>
  );
}
...
function Group35() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-[-0.003%] mt-[-1.139%] place-items-start relative" data-name="Group">
      <Group34 />
    </div>
  );
}
...
function ClipPathGroup1() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[65.058%] mt-0 place-items-start relative" data-name="Clip path group">
      <Group35 />
    </div>
  );
}
...
function Group36() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1.05%] mt-[0.34%] place-items-start relative" data-name="Group">
      <Group2 />
      <Group5 />
      <Group8 />
      <Group11 />
...
function Frame2147236348() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center leading-[0] left-0 top-[26px]">
      <Group37 />
      <div className="flex flex-col font-['DM_Sans:Regular',_sans-serif] font-normal justify-center relative shrink-0 text-[#6f6f6f] text-[24px] tracking-[-1.2px] w-[218px]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function HeroBanner() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Hero banner">
      <div className="[grid-area:1_/_1] bg-[#8e9c78] h-[362px] ml-0 mt-[230px] rounded-[30px] w-[1200px]" />
      <div className="[grid-area:1_/_1] h-[592px] ml-[119px] mt-0 relative w-[962px]" data-name="Group 144 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[110.53%] left-0 max-w-none top-[-0.03%] w-full" src={imgGroup1441} />
        </div>
      </div>
    </div>
  );
...
function Header() {
  return (
    <header className="box-border content-stretch flex flex-col gap-[64px] items-start max-w-[1500px] overflow-clip p-0 relative shrink-0 w-full" data-name="Header">
      <HeroText />
      <HeroBanner />
    </header>
  );
